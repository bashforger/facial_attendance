...
Color kmainColorTeacher = Color.fromRGBO(57, 92, 148, 1.0);
Color kmainColorStudents = Color.fromRGBO(49, 129, 226, 1.0);
Color kmainColorParents = Color.fromRGBO(114, 207, 236, 1.0);
Gradient gradient1 = LinearGradient(colors: [Colors.red, Colors.black]);
